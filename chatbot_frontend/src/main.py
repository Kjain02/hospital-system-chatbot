...
if prompt := st.chat_input("What do you want to know?"):
    ...
    with st.spinner("Searching for an answer..."):
        try:
            ...
            output_text = response_data.get("output", "No response received")
            explanation = response_data.get("intermediate_steps", [])

        except requests.exceptions.RequestException as e:
            output_text = f"An error occurred while processing your message: {str(e)}"
            explanation = ["Error occurred during API call"]
